        .data
buffer:	.space 256
str000:	.asciiz	"Introduzca un n�mero (n) en base 10: "
str001:	.asciiz	": "
str002:	.asciiz	"n en base "
str003:	.asciiz	"\n"
        
        .text
# mueve la l�nea siguiente justo antes de la versi�n que desees probar
...
# Imprime el n�mero recibido en base 10 seguido de un salto de linea
test1:					# $a0 = n
	addiu	$sp, $sp, -4
	sw	$ra, 0($sp)
	li	$a1, 10
...
# Imprime el n�mero recibido en todas las bases entre 2 y 36
test2:					# $a0 = n
	addiu	$sp, $sp, -12
	sw	$ra, 8($sp)
	sw	$s1, 4($sp)
...
main:
	...
	sw	$s0, 0($sp)
	la	$a0, str000
	jal	print_string		# print_string("Introduzca un n�mero (n) en base 10: ")
	jal	read_integer
